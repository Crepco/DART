...
def main():
    ...
    while True:
        ...
        if aim is not None:
            ...
            # frame, exiting reveals it — either edge writes a fictitious step
            # into the derivative (measured: entry pinned pan at -25 for ~1s
            # with the target centered). Re-anchor per axis; D_KICK_LIMIT
            # still guards mid-track box jumps.
